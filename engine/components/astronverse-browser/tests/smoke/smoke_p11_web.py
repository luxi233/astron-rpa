...
name, ok = BrowserElement.wait_any_element(
    browser_obj=b, element_1=mk_ele("ele_a"), name_1="登录页", element_2=mk_ele("ele_b"), name_2="首页", element_timeout=2
)
...
gname, ok = BrowserElement.wait_any_group(
    browser_obj=b2,
    group_a_name="登录页", element_a_1=mk_ele("a1"),
    group_b_name="列表页", element_b_1=mk_ele("b1"), element_b_2=mk_ele("b2"),
    element_timeout=2,
)
...
gname, ok = BrowserElement.wait_any_group(
    ...
    element_b_1=mk_ele("b1"), element_b_2=mk_ele("b2"),
    element_timeout=1,
)
