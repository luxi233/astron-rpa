...
export function checkDebuggerDetached(tabId: number | undefined, attempts = 10) {
...
const Debugger = {
  ...
  handleAttachedTarget: async (source: chrome.debugger.Debuggee, params: { sessionId: any }) => {
    const session = {
      tabId: source.tabId,
